!(function (a) {
  a.fn.betaSelect = function (b) {
    ...
    return this.each(function () {
      var b = a(this),
        c = b
          .wrap("<div class='beta-select " + d.class + "'></div>")
          .closest(".beta-select");
      c.append("<i class='fa fa-chevron-down'></i>"),
        c.prepend(
          "<span class='beta-select-title'>" +
            d.text +
            "</span><span class='beta-select-value'>" +
            d.value +
            "</span>"
        ),
        b.change(function () {
  ...
  !(function () {
    ...
    a.prototype = {
      ...
      initInstragram: function () {
        dug({
          ...
          cacheExpire: 3600,
          template:
            '            {{#data}}                <a href="{{link}}" target="_blank">                  <img src="{{images.low_resolution.url}}">                </a>            {{/data}}',
        });
      },
      initFilter: function () {
        jQuery.fn.slider &&
          (jQuery("#price-filter-range").slider({
            ...
            values: [0, 300],
            slide: function (a, b) {
              jQuery("#price-filter-amount").text(
          ...
          jQuery("#price-filter-amount").text(
            "$" +
              jQuery("#price-filter-range").slider("values", 0) +
              " - $" +
      ...
      initRevolutionSlider: function () {
        if (jQuery.fn.revolution) {
          ...
          jQuery(".tp-banner").hasClass("fullwidth") &&
            ((a.fullWidth = "on"),
            (a.forceFullWidth = "on"),
            (a.startheight = 530)),
      ...
      initRoundabout: function () {
        jQuery.fn.roundabout &&
          jQuery(".beta-roundabout").roundabout({ responsive: !0 });
      },
      ...
      animateBanners: function () {
        jQuery(".beta-banner").each(function (a, b) {
          for (
            var c = jQuery(b).find("[data-animo]"), d = [], e = 0;
            e < c.length;
            e++
          ) {
      ...
      absFullwidth: function () {
        jQuery(".abs-fullwidth").each(function (a, b) {
          var c = jQuery(b).height(),
            d = jQuery(b).find("img");
          jQuery(b).after(
            "<div class='abs-fullwidth-height' style='height:" +
              c +
              "px'></div>"
          ),
            d.length > 0 &&
        ...
        jQuery(".beta-filter-container").each(function (a, b) {
          ...
          d.on("click", function () {
            ...
            for (var c = 0; c < e.length; c++)
              jQuery(e[c]).hasClass(b)
                ? jQuery(e[c]).removeClass("is-item-hidden")
                : jQuery(e[c]).addClass("is-item-hidden");
            return !1;
          });
        });
      },
      ...
      initTabs: function () {
        jQuery(".woocommerce-tabs .panel").hide(),
          jQuery(".woocommerce-tabs ul.tabs li a").click(function () {
            ...
            return (
              jQuery("ul.tabs li", b).removeClass("active"),
          ...
          jQuery(".woocommerce-tabs").each(function () {
            var a = window.location.hash,
              ...
              c = jQuery(this);
            a.toLowerCase().indexOf("comment-") >= 0
              ? jQuery("ul.tabs li.reviews_tab a", c).click()
              : b.indexOf("comment-page-") > 0 || b.indexOf("cpage=") > 0
              ? jQuery("ul.tabs li.reviews_tab a", jQuery(this)).click()
              : jQuery("ul.tabs li:first a", c).click();
          }),
    ...
    jQuery(function () {
      ...
      c.matches &&
        jQuery(".beta-banner .beta-fallback").each(function (a, b) {
          var c = jQuery(b).data("fallback");
          jQuery(b)
            .siblings(".beta-banner-layer")
            .remove()
            .end()
            .attr("src", c);
        });
