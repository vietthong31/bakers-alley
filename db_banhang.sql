...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 02, 2022 at 12:35 PM
...
(1, 'Mrs. Augusta McClure', 'krista.bernier@example.com', '$2y$10$jyfL081NQO/o3FAkALivj.WHOOx1Y3RgClllIVuTxszLKW5Ne4kNG', 'UDYGmjDqul', '2022-10-10 05:50:29', '2022-10-10 05:50:29'),
(2, 'Ava Kris DVM', 'bashirian.ted@example.com', '$2y$10$f8NDLYItJimA3wLUw/URh.g1G.ddkV4McN4JiuyFaTal2Aek9iWQK', 'mDadBETnhO', '2022-10-10 05:50:29', '2022-10-10 05:50:29'),
(3, 'Lenore Jenkins', 'alexander35@example.org', '$2y$10$iLAEYiZKV8HGXe9gk1XQ4.6PCh62ZIufOR6fcfxW8UaO72EZS/tce', 'mQ3CnX29D7', '2022-10-10 05:50:29', '2022-10-10 05:50:29'),
(4, 'Viet Thong', 'thong@mail.com', '$2y$10$zTb0EqraA6FSHlYzW63uz.TJrPkC2pO/rcG9JA6Ag.i1Z5pt8US0u', 'VjJmVdZAKQ', '2022-10-11 01:57:40', '2022-10-11 01:57:40');
...
CREATE TABLE `bills` (
  ...
  `status` enum('Chờ lấy hàng','Hủy','Đã giao','Đã nhận') CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `bills` (`id`, `id_customer`, `date_order`, `total`, `payment`, `status`, `created_at`, `updated_at`) VALUES
(23, 3, '2022-10-19', 280000, 'COD', 'Đã nhận', '2022-10-30 12:36:53', '2022-10-30 05:36:53'),
(22, 3, '2022-10-19', 280000, 'COD', 'Đã nhận', '2022-10-30 12:37:06', '2022-10-30 05:37:06'),
(21, 3, '2022-10-19', 320000, 'COD', 'Hủy', '2022-10-30 12:37:18', '2022-10-30 05:37:18'),
(20, 3, '2022-10-13', 280000, 'COD', 'Đã giao', '2022-10-30 12:37:25', '2022-10-30 05:37:25'),
(19, 3, '2022-10-13', 160000, 'ATM', 'Chờ lấy hàng', '2022-10-30 12:37:31', '2022-10-30 05:37:31'),
(234, 8, '2022-11-01', 160000, 'COD', 'Chờ lấy hàng', '2022-11-01 00:14:17', '2022-11-01 00:14:17');
...
(25, 234, 2, 1, 160000, '2022-11-01 00:14:17', '2022-11-01 00:14:17'),
(24, 23, 13, 1, 280000, '2022-10-19 05:42:02', '2022-10-19 05:42:02'),
(23, 22, 13, 1, 280000, '2022-10-19 05:33:34', '2022-10-19 05:33:34'),
(22, 21, 15, 1, 320000, '2022-10-19 05:32:15', '2022-10-19 05:32:15'),
(21, 20, 13, 1, 280000, '2022-10-13 09:53:11', '2022-10-13 09:53:11'),
(20, 19, 2, 1, 160000, '2022-10-13 04:15:56', '2022-10-13 04:15:56');
...
INSERT INTO `favorite_products` (`id`, `user_id`, `product_id`, `updated_at`, `created_at`) VALUES
(1, 1, 1, '2022-10-26 06:34:55', '2022-10-26 06:34:55'),
(2, 3, 47, NULL, NULL),
(4, 3, 1, '2022-10-28 02:34:05', '2022-10-28 02:34:05'),
(5, 3, 17, NULL, NULL),
(6, 3, 61, NULL, NULL),
(7, 3, 5, NULL, NULL);
...
(1, '2022_10_10_114346_create_admins_table', 1),
...
(1, 'Bánh Crepe Sầu riêng', 5, 'Bánh crepe sầu riêng nhà làm', 150000, 119000, '1430967449-pancake-sau-rieng-6.jpg', 'hộp', 0, '2016-10-26 03:00:16', '2022-10-18 07:35:09'),
(2, 'Bánh Crepe Chocolate', 6, 'Bánh crepe chocolate ngon.', 180000, 160000, 'crepe-chocolate.jpg', 'hộp', 1, '2016-10-26 03:00:16', '2022-10-18 07:42:15'),
...
(1, 'https://baker.com', 'banner1.jpg', NULL, '2022-10-18 04:49:38'),
...
(1, 'Bánh mặn', 'Nếu từng bị mê hoặc bởi các loại tarlet ngọt thì chắn chắn bạn không thể bỏ qua những loại tarlet mặn. Ngoài hình dáng bắt mắt, lớp vở bánh giòn giòn cùng với nhân mặn như thịt gà, nấm, thị heo ,… của bánh sẽ chinh phục bất cứ ai dùng thử.', '20221016011850.jpg', NULL, '2022-10-29 06:26:22'),
...
(1, 'Hector Dare', 'chance.rolfson@example.net', '2022-10-10 05:50:29', '$2y$10$ZkkcwlJ1zHpn8ywmSifOPeW7uAcYXYg8M61AV7pNiLDOhg0/ycXPG', '12 Tran Phu', '0908446118', 'WbZYnuO4fh', '2022-10-10 05:50:29', '2022-10-29 06:16:38'),
(3, 'Ms. Elinor Keebler Jr.', 'sample@mail.com', '2022-10-10 05:50:29', '$2y$10$h/QpUeHvz6fp6C2E0a5MkeaOuimQsrp8vFU4TXhgkGeyOxVnWWKia', '20 Ngo Quyen', '+18175999566', 'nHoSyDsmueAQRbWUt8NTQoV6huhRhPzbVKNXWOb8b7bhljH7NbEdp4sWyAhW', '2022-10-10 05:50:29', '2022-10-10 05:50:29'),
(8, 'Thong Nguyen', 'newacc@mail.com', NULL, '$2y$10$y0eeCErUvl86PcbdaR0tBuy/FYnuNmJgd3K9IdBMZTKTg1SLJ24aO', '89 Phan Chau Trinh', '0951291203', NULL, '2022-11-01 00:09:07', '2022-11-01 00:09:07');
...
ALTER TABLE `favorite_products`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_favor_user` (`user_id`),
  ADD KEY `fk_favor_product` (`product_id`);
...
--
ALTER TABLE `favorite_products`
  ADD CONSTRAINT `fk_favor_product` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_favor_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
